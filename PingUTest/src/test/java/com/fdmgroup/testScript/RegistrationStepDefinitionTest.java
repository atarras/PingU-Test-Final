...
public class RegistrationStepDefinitionTest {
	...
	public void successfullRigister() throws InterruptedException{
		...
		Thread.sleep(2000);
		String actualSignUpSuccessMessage = driver.findElement(By.className("error-message")).getText(); 
		assertEquals(DataFile.signUpValidateMessage, actualSignUpSuccessMessage);
		Thread.sleep(2000);
	}
